...
argo submit -n argo --watch bitcoin-comment-getter.yaml # note this is set up for one year data not to, edite file to change
# argo submit -n argo --watch bitcoin-comment-getter-missing.yaml

argo submit -n argo --watch bitcoin-comment-process.yaml

# submit germen power plants workflow
argo submit -n argo --watch germanen.yaml

argo submit -n argo --watch germanen-store-s3.yaml
